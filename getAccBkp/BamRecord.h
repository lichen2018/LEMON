 ...
 */
 ...
 //std::unordered_map<std::string, size_t> CigarMap;
...
class BamRecord {
 ...
 public:
   ...
   */
  BamRecord(const std::string& name, const std::string& seq, const std::string& ref);
   ...
   */
  inline std::string ChrName(const BamHeader& h) const {
    if (b->core.tid < 0)
      return std::string();
